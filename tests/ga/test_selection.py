...
class TestSelection:
    ...
    def test_tournament_selection_best_always_wins(self):
    ...
    def test_tournament_selection_different_sizes(self):
    ...
    def test_tournament_selection_single_tournament(self):
    ...
    def test_tournament_selection_bias_toward_higher_fitness(self):
        population = [[0, 0], [1, 1]]
    ...
    def test_roulette_selection_basic(self):
        population = [[1, 0, 1], [0, 1, 0], [1, 1, 1], [0, 0, 0]]
        fitness_scores = [10, 15, 20, 5]
    ...
    def test_roulette_selection_zero_fitness(self):
        population = [[1, 0], [0, 1]]
        fitness_scores = [0, 0]
    ...
    def test_roulette_selection_bias_toward_higher_fitness(self):
        population = [[0, 0], [1, 1]]
        fitness_scores = [1, 99]
    ...
    def test_roulette_selection_equal_fitness(self):
        population = [[1, 0], [0, 1], [1, 1], [0, 0]]
    ...
    def test_roulette_selection_single_individual(self):
        population = [[1, 0, 1]]
        fitness_scores = [15]
    ...
    def test_selection_functions_preserve_individuals(self):
    ...
    def test_tournament_selection_large_population(self):
    ...
    def test_selection_functions_return_copies(self):
    ...
    def test_fitness_scores_length_mismatch(self):
        population = [[1, 0], [0, 1], [1, 1]]
        fitness_scores = [10, 15]
